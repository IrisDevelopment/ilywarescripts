...
-----OPTIONS
local ToolName = "Black Demon Trident" ----- the hats name on explorer/dex (not name in catalog)
...
tl1.Color = ColorSequence.new(BrickColor.new('Amaranth').Color)
tl1.Lifetime = 0.8
tl1.Enabled = false
...
for i = 0, 4, 0.1 do
swait()
sphere2(5,"Add",larm.CFrame*CFrame.new(0,-1.5,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),-0.01,0.1,-0.01,BrickColor.new("Amaranth"),BrickColor.new("Amaranth").Color)
...
orb.Anchored = true
orb.BrickColor = BrickColor.new("Amaranth")
...
tl1.Color = ColorSequence.new(BrickColor.new('Amaranth').Color,BrickColor.new('Cyan').Color)
tl1.Lifetime = 5
local tl2 = tl1:Clone()
